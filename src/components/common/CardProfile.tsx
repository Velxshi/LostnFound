        ...
        <div className="bg-cream-light-hover rounded-2xl px-6 py-2 md:py-3 flex gap-3 md:gap-5 items-center w-full max-w-2xl shadow mb-6 md:mb-9">
          <div className="bg-primary p-1 rounded-full h-full w-auto shadow">
            <Image
              ...
              alt="profile"
              className="object-cover rounded-full h-full w-auto aspect-square md:w-14 md:h-14"
              width={48}
              height={48}
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-primary font-poppins font-bold text-title2 md:text-h5">
              Reina Ueda
            </h1>
            <h4 className="text-dark font-jakarta text-body md:text-title2">
              ueshama_148@gmail.com
            </h4>
          </div>
        </div>
      </BlurFade>
