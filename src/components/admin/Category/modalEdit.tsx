...
const handleedit = async (e: any) => {
    ...
    <div className=" mx-auto w-full max-w-lg">
        ...
        <div className="flex flex-col rounded-t-4xl gap-1 p-8 pb-0">
            <h3 className="text-[25px] font-bold font-poppins text-slate-800 md:justify-center md:items-center flex">Edit Kategori</h3>
            <p className="text-[13px] font-normal font-poppins text-slate-800">Edit Kategori Anda</p>
            </div>
