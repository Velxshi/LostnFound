        ...
        <div className="container flex flex-col">
            ...
            <div className="card-container grid grid-cols-2 lg:grid-cols-4 lg:gap-16 gap-3 mt-3">
                <div className="card w-full h-24.5 md:h-36  bg-[#FEFEFE] rounded-[20px] flex flex-col items-center justify-center gap-2">
                    <div className="logo">
                        <Icon icon="tabler:database" className="text-title1 md:text-[30px] lg:text-[33px] text-[#2848B7]"/>
                    </div>
                ...
                <div className="card w-full h-24.5 md:h-36 bg-[#FEFEFE] rounded-[20px] flex flex-col items-center justify-center gap-2">
                    <div className="logo">
                        <Icon icon="tabler:package" className="text-title1 md:text-[30px] lg:text-[33px] text-[#2848B7]"/>
                    </div>
                ...
                <div className="card w-full h-24.5 md:h-36 bg-[#FEFEFE] rounded-[20px] flex flex-col items-center justify-center gap-2">
                    <div className="logo">
                    <Icon icon="tabler:help-circle" className="text-title1 md:text-[30px] lg:text-[33px] text-[#2848B7]"/>
                ...
                <div className="card w-full h-24.5 md:h-36 bg-[#FEFEFE] rounded-[20px] flex flex-col items-center justify-center gap-2">
                    <div className="logo ">
                    <Icon icon="material-symbols:handshake-outline" className="text-title1 md:text-[30px] lg:text-[33px] text-[#2848B7]"/>
                    </div>
