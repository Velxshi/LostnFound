...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f7f3f0]/90 overflow-hidden">
      {/* Background */}
      <div className={`fixed inset-0 flex items-center justify-center z-50 ${isExiting ? "animate-slideUp bg-[#f7f3f0]/70 backdrop-blur-sm" : "bg-[#f7f3f0]"}`} />

      {/* Splash */}
      {!isRemoved && (
        <div className={`fixed inset-0 flex items-center justify-center bg-[#f7f3f0] z-50 ${isExiting ? "animate-slideUp" : ""}`}>
          <div className="text-center animate-fadeIn">
            <Image alt="logo" src="/assets/logo/Logo.svg" className="w-30 mx-auto mb-4 animate-scaleIn" width={120} height={120} />
